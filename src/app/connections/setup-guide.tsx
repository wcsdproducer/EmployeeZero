...
export const GOOGLE_SUITE_GUIDES: Record<string, SetupStep[]> = {
  ...
  gmail: [
    { step: 1, text: "Coming soon — requires OAuth consent flow" },
    { step: 2, text: "Will use your Gmail with your permission to read and send emails" },
  ],
  calendar: [
    { step: 1, text: "Coming soon — requires OAuth consent flow" },
    { step: 2, text: "Will sync with your Google Calendar for scheduling" },
  ],
  drive: [
    { step: 1, text: "Coming soon — requires OAuth consent flow" },
    { step: 2, text: "Will access your files with granular permissions" },
  ],
  sheets: [
    { step: 1, text: "Coming soon — requires OAuth consent flow" },
    { step: 2, text: "Will read and write to your spreadsheets" },
  ],
};
