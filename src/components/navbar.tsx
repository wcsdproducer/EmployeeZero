    ...
    <nav className="h-16 border-b border-neutral-100 bg-white/80 backdrop-blur-md sticky top-0 z-50 flex items-center justify-between px-6">
      <div className="flex items-center gap-8">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/blog" className="text-sm text-neutral-500 hover:text-black transition-colors underline decoration-emerald-500/30 underline-offset-4">Blog</Link>
          <Link href="/setup" className="text-sm text-neutral-500 hover:text-black transition-colors">Setup</Link>
