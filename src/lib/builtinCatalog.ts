...
export const BUILTIN_TOOLS: BuiltinTool[] = [
  ...
  { id: "builtin-read-email", name: "Read & Summarize Email", description: "Read the full content of an email and produce a concise summary with action items.", toolNames: ["read_email"], requiredConnections: ["gmail"], category: "email", icon: "📨" },
  { id: "builtin-email-triage", name: "Email Triage", description: "List unread emails, categorize by urgency, and mark as read.", toolNames: ["search_emails", "get_unread_count", "mark_as_read", "archive_email"], requiredConnections: ["gmail"], category: "email", icon: "📬" },
  // Drive
  { id: "builtin-search-drive", name: "Search Google Drive", description: "Search for files and documents in Google Drive by name, type, or keyword.", toolNames: ["list_drive_files", "get_drive_file"], requiredConnections: ["drive"], category: "drive", icon: "🗂️" },
  { id: "builtin-drive-organizer", name: "Drive Organizer", description: "Create folders, move files, and rename items to organize your Google Drive structure.", toolNames: ["create_drive_folder", "move_drive_file", "rename_drive_file", "copy_drive_file"], requiredConnections: ["drive"], category: "drive", icon: "📁" },
  { id: "builtin-drive-sharer", name: "Share Files & Set Permissions", description: "Share Drive files or folders with specific people or make them public.", toolNames: ["share_drive_file", "get_drive_file"], requiredConnections: ["drive"], category: "drive", icon: "🔗" },
  { id: "builtin-drive-uploader", name: "Upload to Drive", description: "Upload files to Google Drive and get a shareable link.", toolNames: ["upload_drive_file", "share_drive_file"], requiredConnections: ["drive"], category: "drive", icon: "⬆️" },
  // Docs
  ...
  { id: "builtin-write-sheet", name: "Write to Google Sheet", description: "Write or update data in a Google Sheet. Overwrites a range or appends new rows.", toolNames: ["write_sheet", "append_to_sheet"], requiredConnections: ["sheets"], category: "sheets", icon: "✏️" },
  ...
  { id: "builtin-create-sheet", name: "Create Spreadsheet", description: "Create a brand new Google Sheets file with one or more named tabs.", toolNames: ["create_spreadsheet", "add_sheet_tab"], requiredConnections: ["sheets"], category: "sheets", icon: "📋" },
  { id: "builtin-sheet-manager", name: "Manage Sheet Tabs", description: "Add, delete, rename, duplicate, or sort sheets within a Google Sheets file.", toolNames: ["add_sheet_tab", "delete_sheet_tab", "rename_sheet_tab", "duplicate_sheet_tab", "sort_sheet_range"], requiredConnections: ["sheets"], category: "sheets", icon: "🗂️" },
  // Slides
  ...
  { id: "builtin-post-twitter", name: "Post to Twitter / X", description: "Publish a tweet to the user's Twitter/X account. Supports up to 280 characters.", toolNames: ["create_tweet"], requiredConnections: ["twitter"], category: "social", icon: "🐦" },
